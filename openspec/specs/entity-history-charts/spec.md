...
Per-entity historical metrics charts for processes and containers, reachable from the PID and Name links in the metric tables, with period filtering and chart data served from stored metric rows.
